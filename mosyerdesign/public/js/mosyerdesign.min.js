(function () {
	...
	$(document).ready(function () { 
	 ...
	 class DesktopPage {
		...
		make_latest(){
			...
			Object.keys(this.data.latest.items).forEach(function (key) {
				console.log(key);
				var parent = $(("<div class=\"widget widget-shadow dashboard-widget-box\" style=\"margin-top: 8px;\">\n\t\t\t\t<div class=\"widget-head\">\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<div class=\"widget-title ellipsis\" title=\"Clinical Procedures\">" + (__(key)) + "</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"widget-body shorts-links\"></div>\n\t\t\t</div>"));
				new frappe.widget.WidgetGroup({
					...
					columns: 1,
					options: {},
					widgets: this$1.data.latest.items[("" + key)] || []
				});
				this$1.page.find('.latest-parent').append(parent);
			});
		}
	...
	frappe.utils.icon = function(icon_name, size, icon_class, icon_style, svg_class) {
	    ...
	    var faws_style = ("" + icon_name).startsWith('faws-') ? "fill: #171717;" : "";
